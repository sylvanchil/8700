#include"viewpoint.h"
#include<cmath>
Point2d Viewpoint::lookAt3dPoint(const Point3d& p3d){
...
Line2d Viewpoint::lookAt3dLine(const Line3d& l3d){
	return Line2d(lookAt3dPoint(l3d.p1), lookAt3dPoint(l3d.p2));
}
