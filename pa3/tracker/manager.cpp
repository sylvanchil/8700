...
#include "randomcloudmultisprite.h"
#include "sprite.h"
#include "gamedata.h"
#include "manager.h"
...
//	sprites.push_back( new MultiSprite("matchman") );
	...
	sprites.push_back( new MatchmanMultiSprite("matchman") );
	
	sprites.push_back(new MultiSprite("grass"));
	for(int i =0;i < 10;i ++){
	sprites.push_back(new RandomCloudMultiSprite("cloud"));
	}
